...
const S=['fold the wick low, then light it and swipe the flame away','now swipe across the flame — it hides as an ember','fold the wick low first — then light it and swipe','service it properly: pull the insert up and out','a hard shake snuffs it; a sharp jerk makes it lurch'];
